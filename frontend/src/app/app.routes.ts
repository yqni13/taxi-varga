    ...
    },
    {
        ...
        data: {
            ...
            preloadImages: [
                ...
                '/assets/app-icons/icon_home.svg',
                '/assets/app-icons/icon_about.svg',
                '/assets/app-icons/icon_service.svg',
                '/assets/app-icons/icon_samples.svg',
                '/assets/app-icons/icon_warning.svg',
            ]
        }
    },
    {
