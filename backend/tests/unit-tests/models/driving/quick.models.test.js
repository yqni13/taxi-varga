...
describe('Quick tests, priority: _calcServDistCosts', () => {
    ...
    describe('Testing valid fn calls', () => {
        ...
        describe('Testing with params: <back2origin> = false', () => {
            ...
            // test('Route (ABCDtoEFGH), params: servDist <= 2, isRouteV2V = true', () => {
            //     //
            // })

            // test('Route (ABCDtoEFGH), params: servDist <= 2, isRouteV2V = false', () => {
            //     //
            // })

            // test('Route (ABCDtoEFGH), params: servDist <= 8, isRouteV2V = false', () => {
            //     //
            // })

            // test('Route (ABCDtoEFGH), params: servDist <= 8, isRouteV2V = true', () => {
            //     //
            // })
            ...
            // test('Route (1230to2345), params: <servDist> < 8', () => {
            ...
            // test('Route (1180to1100), params: <servDist> > 8 <= 20', () => {
            ...
            // test('Route (1190to4020), params: <servDist> > 20', () => {
        ...
        describe('Testing with params: <back2origin> = true', () => {
            ...
            test('Route (1100to1040), params: <back2origin> = true, service distance > 8', () => {
